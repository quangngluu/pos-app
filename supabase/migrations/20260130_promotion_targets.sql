...
DROP TRIGGER IF EXISTS set_promotion_targets_timestamp ON public.promotion_targets;
...
DROP POLICY IF EXISTS "promotion_targets_select_policy" ON public.promotion_targets;
CREATE POLICY "promotion_targets_select_policy" ON public.promotion_targets
  FOR SELECT USING (true);

-- Only authenticated admin users can modify
DROP POLICY IF EXISTS "promotion_targets_insert_policy" ON public.promotion_targets;
CREATE POLICY "promotion_targets_insert_policy" ON public.promotion_targets
  FOR INSERT WITH CHECK (auth.role() = 'authenticated');

DROP POLICY IF EXISTS "promotion_targets_update_policy" ON public.promotion_targets;
CREATE POLICY "promotion_targets_update_policy" ON public.promotion_targets
  FOR UPDATE USING (auth.role() = 'authenticated');

DROP POLICY IF EXISTS "promotion_targets_delete_policy" ON public.promotion_targets;
